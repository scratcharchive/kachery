            ...
            <Table>
                <TableBody>
                    <TableRow>
                        ...
                        <TableCell>{path0}</TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>Size</TableCell>
                        <TableCell>{(item.data.file || {}).size}</TableCell>
                    </TableRow>
                </TableBody>
            </Table>
        );
        ...
        table = (
            <Table>
                <TableBody>
                    <TableRow>
                        <TableCell>Path</TableCell>
                        <TableCell><a href="#" onClick={() => { props.onOpenPath && props.onOpenPath(item.path) }}>{item.path}</a></TableCell>
                    </TableRow>
                </TableBody>
            </Table>
        );
