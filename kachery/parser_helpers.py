...
def _add_download_args(parser):
    parser.add_argument('--fr', '-f', help='Where to load from', required=False, default='local')
...
def _add_upload_args(parser):
    parser.add_argument('--to', '-t', help='Where to store to', required=False, default='local')
